...
async def upload_exercise_image(data: bytes, content_type: str, exercise_id: str) -> str:
    return await _upload_exercise_asset(data, content_type, "image", EXERCISES_V2_IMAGE_FOLDER, exercise_id)
